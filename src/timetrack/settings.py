...
MIDDLEWARE = [
    ...
    "timetrack.accounts.middleware.LoginRequiredMiddleware",
]
...
GOOGLE_OAUTH_REDIRECT_URI = env(
    "GOOGLE_OAUTH_REDIRECT_URI", default="http://localhost:8000/gcal/oauth/callback/"
)
GOOGLE_OAUTH_SCOPES = [
...
STRAVA_REDIRECT_URI = env(
    "STRAVA_REDIRECT_URI", default="http://localhost:8000/strava/callback/"
)
